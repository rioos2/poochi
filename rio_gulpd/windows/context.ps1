...
function runGulpd()
{
    $assemblies_id = $context["ASSEMBLIES_ID"]
    $account_id = $context["ACCOUNTS_ID"]
    $assembly_id = $context["ASSEMBLY_ID"]
    $api_key = $context["API_KEY"]
    $node_name = $context["NODE_NAME"]
(Get-Content  C:\Users\Administrator\gulp\gulp\gulpd.conf) -replace 'assemblies_id_value', $assemblies_id | Set-Content C:\Users\Administrator\gulp\gulp\gulpd.conf
(Get-Content  C:\Users\Administrator\gulp\gulp\gulpd.conf) -replace 'account_id_value', $account_id | Set-Content C:\Users\Administrator\gulp\gulp\gulpd.conf
